							...
							<div class="size-209 p-r-18 p-r-0-sm w-full-ssm">
								...
								<div class="p-t-15">								
									...
									<div class="rs1-select2 rs2-select2 bor8 bg0 m-b-12 m-t-9">
										<input type="text" name="paymentMethod" placeholder="Transcation ID or COD" ><br>
										<span>GPay QR Code</span>
										<img src="images/QR2.jpg" alt="qrcode" style="height:100px;width:100px">
									</div>
